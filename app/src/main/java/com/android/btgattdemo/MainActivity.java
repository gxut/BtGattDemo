...
import com.android.btgattdemo.client.DeviceScanActivity;
import com.android.btgattdemo.server.BleServerActivity;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            case R.id.client:
                final Intent intentClient = new Intent(this, DeviceScanActivity.class);
                startActivity(intentClient);
                break;
            case R.id.server:
                final Intent intentServer = new Intent(this, BleServerActivity.class);
